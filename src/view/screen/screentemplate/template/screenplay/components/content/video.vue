...
// import video from '@/assets/scrren/videos/7f35dc7086d338717cf51f5049609a79.mp4';
...
<template>
    <div class="w-[650px] h-[535px]">
        <dv-border-box12 class="w-full h-full">
            <div class="justify-content align-items w-full flex" v-if="title !== ''">
                <!-- <Decoration1 style=" width: 80px; height: 40px;" /> -->
                <div class="item_title">
                    <div class="zuo"></div>
                    <dv-decoration-9 style="width:80px;height:80px; "></dv-decoration-9>
            ...
            <div :class="title !== '' ? 'item_title_content' : 'item_title_content_def'">
                <div v-if="typid === -3" class="w-[643px] h-[640px]  pl-1.5  pt-2">
                    <video-player autoplay :options="playerOptions" class="video-player vjs-custom-skin w-[655px] h-[520px]"
			  ref="videoPlayer"
			  :playsinline="true"
			  :src="videosrc"
			  />
