...
function fetchData() {
	axios
		.get<
			TeamAnswer[]
		>('/teach/scene/getTeamAnswerProgressData', { params: { teachPlanId: params.teachPlanId, answerTableType: 3 } })
		.then((res) => {
			data.value = res.data;
		});
}
...
<template>
	<a-divider class="my-2">课后练习答题情况</a-divider>
	<table class="w-full border border-[#b4d3ff]">
		<thead>
			...
			<tr>
				<td colspan="1" class="border border-[#b4d3ff] text-center w-10">小组排名</td>
				<td colspan="2" class="border border-[#b4d3ff] text-center w-10">小组名称</td>
				<td class="border border-[#b4d3ff] text-center w-10">小组得分</td>
				<td colspan="2" class="border border-[#b4d3ff] text-center w-20">小组成员</td>
				<td colspan="1" class="border border-[#b4d3ff] text-center w-10">组内排名</td>
				<td colspan="4" class="border border-[#b4d3ff] text-center">答题情况</td>
				<td colspan="1" class="border border-[#b4d3ff] text-center w-14">得分</td>
				<td colspan="1" class="border border-[#b4d3ff] text-center w-14">正确率</td>
