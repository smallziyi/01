...
<template>
	...
	<a-card :body-style="{ padding: '16px' }" :bordered="false" style="min-height: calc(100vh - 206px)">
		...
		<template #extra>
			<user-add-batch user-type="student" @success="reset"></user-add-batch>
	...
	<user-add v-if="state.createOpen" v-model:open="state.createOpen" role-code="student" @success="reset" />
</template>
