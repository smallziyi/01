...
<template>
	...
	<a-card :body-style="{ padding: '16px' }" :bordered="false" style="min-height: calc(100vh - 206px)">
		...
		<template #extra>
			<user-add-batch user-type="teacher" @success="reset"></user-add-batch>
	...
	<user-add v-if="state.createOpen" role-code="teacher" v-model:open="state.createOpen" @success="reset" />
</template>
