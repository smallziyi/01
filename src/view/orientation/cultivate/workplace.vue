...
import ReportCardWorkplace from '@/view/__report/components/card-list/report-workplace-card.vue';
	...
	<template v-else>
		<a-card size="small" :bordered="false">
			...
			<div class="flex gap-4">
				<report-card-workplace :report-type="REPORT_TYPE.CULTIVATE" :report="report!" />
