...
const pageState = reactive<{
	...
	activeId: '',
	showInfo: false,
	params: { reportType: REPORT_TYPE.CULTIVATE, pageType: REPORT_PAGE_TYPE.AUDIT },
});
const fetchData = () => {
...
<template>
	<report-query :report-type="REPORT_TYPE.CULTIVATE" :params="pageState.params" @select="fetchData" />
	<a-card :body-style="{ padding: '16px' }" :bordered="false" size="small" style="min-height: calc(100vh - 301px)">
		<template #title>
			<div class="card-title">人才培养方案审核列表</div>
		</template>
